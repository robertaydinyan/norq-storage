...
class WarehouseController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            Notifications::setNotification(1,"Պահեստ՝ <b>".$model->name."</b> հաջողությամբ ստեղծվել է",'/warehouse/view?id='.$model->id);
            Notifications::setNotification($model->responsible_id,"Պահեստ՝ <b>".$model->name."</b> հաջողությամբ ստեղծվել է",'/warehouse/view?id='.$model->id);
            return $this->redirect(['index']);
        }
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            //     }
            // }
            Notifications::setNotification(1,"Պահեստ՝ <b>".$model->name."</b> հաջողությամբ փոփոխվել է",'/warehouse/view?id='.$model->id);
            Notifications::setNotification($model->responsible_id,"Պահեստ՝ <b>".$model->name."</b> հաջողությամբ փոփոխվել է",'/warehouse/view?id='.$model->id);
