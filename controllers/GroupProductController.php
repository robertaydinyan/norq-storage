...
class GroupProductController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Notifications::setNotification(1,"Ստեղծվել է ապրանքի խումբ ՝ <b>".$model->name."</b> ",'/group-product');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Notifications::setNotification(1,"փոփոխվել է ապրանքի խումբ ՝ <b>".$model->name."</b> ",'/group-product');
            return $this->redirect(['view', 'id' => $model->id]);
        }
    ...
    public function actionDeleteGroup()
    {
        ...
        Notifications::setNotification(1,"Ջնջվել է ապրանքի խումբ ՝ <b>".$id."</b> ",'/group-product');
