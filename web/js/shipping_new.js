function showInfo(id){
    if(id){
        $('.hide-block').hide();
        $.ajax({
            url: '/shipping-request/get-shipping-info',
            method: 'get',
            dataType: 'html',
            data: { id: id},
...
function showInvoices(id){
    if(id){
        $('.hide-block').hide();
        $.ajax({
            url: '/suppliers-list/get-info-pay',
            method: 'get',
            dataType: 'html',
            data: { id: id},
            success: function (data) {
...
function selectProduct(){
    ...
    $.ajax({
        url: '/product/get-products-popup',
        method: 'get',
        dataType: 'html',
        success: function (data) {
...
function selectProductNamiclature(el_){
    el = el_;
    $.ajax({
        url: '/product/get-products-popup-nomeclature',
        method: 'get',
        dataType: 'html',
        success: function (data) {
            $('#showProducts').html(data);
...
function selectWarehouse(el_){
    el = el_;
    $.ajax({
        url: '/warehouse/get-warehouses-popup',
        method: 'get',
        dataType: 'html',
        success: function (data) {
...
function checkMac(el_){
    if(el_){
        $('.hide-block').hide();
        $.ajax({
            url: '/shipping-request/check-mac-address',
            method: 'get',
            dataType: 'json',
            data: { mac: el_.val()},
            success: function (data) {
...
window.onload = function(){
        ...
        $('#shippingrequest-shipping_type').on('change', function(){
           ...
           if($(this).val() == 2 || $(this).val() == 6 || $(this).val() == 5){
            var tp = $(this).val();
               $.get( "/shipping-request/create-product", function( data ) {
        ...
        $('body').on('change','.region_',function(){
            ...
            $('body').on('change','.virtual_type',function(){
                ...
                $('.ware').show();
                $.ajax({
                    url: '/warehouse/get-warehouses-by-type',
                    method: 'get',
                    dataType: 'html',
