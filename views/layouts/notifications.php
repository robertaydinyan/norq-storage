...
$this->registerJs("debugger;$('.fa-bell').closest('.dropdown-toggle').append('<small class=\"badge notifications-count badge-success\" style=\"top:-10px;font-size:50%;\">".$notification_count."</small>');
