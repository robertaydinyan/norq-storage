...
<div class="row product-form module-service-form-card" style="position:relative;">
    <div class="form-group field-product-nomenclature_product_id required col-sm-2">
    ...
    <div class="form-group field-product-price col-sm-2">
    ...
    <div class="form-group field-product-comment col-sm-2">
    ...
    <div class="form-group field-product-count col-sm-2">
    ...
    <div class="rem col-sm-2" style="position: absolute;right:-5px; top: 25px;" onclick="$(this).closest('.product-form').remove()"><i style="color:red;font-size:30px;" class="fa fa-times"></i></div>
    <div class="form-group field-product-mac_address hide col-sm-2">
    ...
    <input type="hidden" name="Product[notice_if_move][]" class="is_vip col-sm-2" value="0">
