...
/* @var $modelNProduct app\models\ShippingRequest */
...
$this->registerJsFile('@web/js/shipping.js', ['depends' => 'yii\web\JqueryAsset', 'position' => \yii\web\View::POS_END]);
...
<div style="display: flex">
    <div class="shipping-product-form col-lg-4">
        ...
        <?= $form->field($shippingModel, 'shipping_type', [
            ...
            'data' => \app\models\Shipping::getType(),
            'maintainOrder' => true,
            'hideSearch' => true,
            'options' => [
