<nav id="w4" class="main-header navbar navbar-expand bg-white navbar-light ">
    <div id="w3-collapse" class="collapse navbar-collapse">
        <ul id="w5" class="navbar-nav w-100 nav">
            ...
            <li class="nav-item"><a class="nav-link" href="/suppliers-list">Գործընկերներ</a></li>
            ...
            <li class="nav-item"><a class="nav-link" href="/shipping-product">Ապրանքի տեղափոխություն</a></li>
            <li class="nav-item"><a class="nav-link" href="/warehouse">Հիմնական պահեստ</a></li>
            <li class="nav-item"><a class="nav-link" href="/product">Ապրանքներ</a></li>
        </ul>
    </div>
</nav>