...
$this->registerJsFile('@web/js/formWarehouse.js', ['depends'=>'yii\web\JqueryAsset', 'position' => \yii\web\View::POS_END]);
            ...
            <div class="col-sm-12 mt-3">
                <?= $form->field($address, 'country_id[]', [
                    ...
                    'options' => [
                        ...
                        'id' => 'countries_comp',
                        'placeholder' => Yii::t('app', 'Ընտրել'),
                        'data-url' => Url::to(['/place/get-regions-by-country'])
                    ],
                    'pluginOptions' => [
                        'allowClear' => true
                    ],
            ...
            <div class="col-sm-4">
                <?= $form->field($address, 'region_id[]', [
                    ...
                    'options' => [
                        ...
                        'id' => 'regions_comp',
                        'placeholder' => Yii::t('app', 'Ընտրել'),
                        'data-url' => Url::to(['/place/get-cities-by-region'])
                    ],
                    'pluginOptions' => [
                        'allowClear' => true
                    ],
            ...
            <div class="col-sm-4">
                <?= $form->field($address, 'city_id[]', [
                    ...
                    'options' => [
                        ...
                        'id' => 'city_comp',
                        'placeholder' => Yii::t('app', 'Ընտրել'),
                        'data-url' => Url::to(['/place/get-streets-by-city']),
                        'disabled' => true,
                    ],
                    'pluginOptions' => [
                        'allowClear' => true
            ...
            <div class="col-sm-4">
                <?= $form->field($address, 'community_id[]', [
                    ...
                    'options' => [
                        ...
                        'id' => 'community_id',
                        'placeholder' => Yii::t('app', 'Ընտրել'),
                        'data-url' => Url::to(['/place/get-streets-by-community']),
                        'disabled' => true,
                    ],
                    'pluginOptions' => [
                        'allowClear' => true
